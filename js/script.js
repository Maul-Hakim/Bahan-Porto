// mobile nav toggle
  ...
  const cvHrefByLang = {
    id: 'assets/cv/CV-Muhammad_Mauli_Al_Hakim-ID.pdf',
    en: 'assets/cv/CV-Muhammad_Mauli_Al_Hakim-EN.pdf'
  };
  ...
  function setLanguage(lang){
    ...
    if(cvBtn && cvHrefByLang[lang]){
      cvBtn.setAttribute('href', cvHrefByLang[lang]);
    }
